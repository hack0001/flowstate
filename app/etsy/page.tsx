                    ...
                    return (
                      <div key={id}>
                        ...
                        >
                          ...
                          <button onClick={e => { e.stopPropagation(); savePriority([id, ...validOrder.filter(i => i !== id)]) }} style={{ background:'none', border:'none', color:'#ff6b35', cursor:'pointer', padding:'0.2rem 0.2rem', fontSize:'0.65rem', lineHeight:1, fontFamily:'inherit', flexShrink:0, borderRadius:'0.25rem', fontWeight:700 }} title="Send to top">&#8593;</button>
                          <button onClick={e => { e.stopPropagation(); savePriority([...validOrder.filter(i => i !== id), id]) }} style={{ background:'none', border:'none', color:'#ff6b35', cursor:'pointer', padding:'0.2rem 0.2rem', fontSize:'0.65rem', lineHeight:1, fontFamily:'inherit', flexShrink:0, borderRadius:'0.25rem', fontWeight:700 }} title="Send to bottom">&#8595;</button>
                          <button
